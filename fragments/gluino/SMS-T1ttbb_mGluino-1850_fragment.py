...
# ---------------------------------------------------------------------------
# T1ttbb  |  mGluino = 1850 GeV  |  mLSP 29점: 1 ~ 1600
# 생성: work/fragments/make_gluino_fragments.py
#   SLHA        <- Run2 승인본 frag_T1ttbb.py
...
MGLUINO = 1850
MLSP_POINTS = [1, 25, 50, 75, 100, 150, 200, 300, 400, 500, 600, 700, 800, 850, 900, 950, 1000, 1050, 1100, 1150, 1200, 1250, 1300, 1350, 1400, 1450, 1500, 1550, 1600]
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-1850_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
