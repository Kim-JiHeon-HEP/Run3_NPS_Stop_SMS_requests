...
# ---------------------------------------------------------------------------
# T1tttt  |  mGluino = 700 GeV  |  mLSP 8점: 1 ~ 475
...
MGLUINO = 700
MLSP_POINTS = [1, 100, 200, 300, 350, 400, 450, 475]
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-700_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
