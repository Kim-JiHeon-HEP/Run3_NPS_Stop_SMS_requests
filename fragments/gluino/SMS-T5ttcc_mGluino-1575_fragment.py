...
# ---------------------------------------------------------------------------
# T5ttcc  |  mGluino = 1575 GeV  |  mLSP 5점: 1375 ~ 1465
...
MGLUINO = 1575
MLSP_POINTS = [1375, 1400, 1425, 1450, 1465]
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-1575_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
