...
# ---------------------------------------------------------------------------
# T1ttbb  |  mGluino = 2700 GeV  |  mLSP 21점: 1 ~ 1600
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-2700_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
