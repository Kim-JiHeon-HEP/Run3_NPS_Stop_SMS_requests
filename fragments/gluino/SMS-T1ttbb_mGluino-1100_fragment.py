...
# ---------------------------------------------------------------------------
# T1ttbb  |  mGluino = 1100 GeV  |  mLSP 13점: 1 ~ 875
...
MGLUINO = 1100
MLSP_POINTS = [1, 100, 200, 300, 400, 500, 600, 650, 700, 750, 800, 850, 875]
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-1100_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
