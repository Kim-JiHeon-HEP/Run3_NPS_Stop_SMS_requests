...
# ---------------------------------------------------------------------------
# T5ttcc  |  mGluino = 1375 GeV  |  mLSP 5점: 1175 ~ 1265
...
MGLUINO = 1375
MLSP_POINTS = [1175, 1200, 1225, 1250, 1265]
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-1375_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
