...
# ---------------------------------------------------------------------------
# T1ttbb  |  mGluino = 1300 GeV  |  mLSP 21점: 1 ~ 1075
...
MGLUINO = 1300
MLSP_POINTS = [1, 25, 50, 75, 100, 150, 200, 300, 400, 500, 600, 650, 700, 750, 800, 850, 900, 950, 1000, 1050, 1075]
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-1300_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
