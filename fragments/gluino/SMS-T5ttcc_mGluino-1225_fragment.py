...
# ---------------------------------------------------------------------------
# T5ttcc  |  mGluino = 1225 GeV  |  mLSP 5점: 1025 ~ 1115
...
MGLUINO = 1225
MLSP_POINTS = [1025, 1050, 1075, 1100, 1115]
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-1225_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
