...
# ---------------------------------------------------------------------------
# T1tttt  |  mGluino = 1850 GeV  |  mLSP 25점: 1 ~ 1600
# 생성: work/fragments/make_gluino_fragments.py
#   SLHA        <- Run2 승인본 frag_T1tttt.py
...
MGLUINO = 1850
MLSP_POINTS = [1, 100, 200, 300, 400, 500, 600, 700, 800, 850, 900, 950, 1000, 1050, 1100, 1150, 1200, 1250, 1300, 1350, 1400, 1450, 1500, 1550, 1600]
