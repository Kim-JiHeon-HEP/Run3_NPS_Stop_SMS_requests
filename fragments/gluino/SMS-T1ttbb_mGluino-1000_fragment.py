...
# ---------------------------------------------------------------------------
# T1ttbb  |  mGluino = 1000 GeV  |  mLSP 11점: 1 ~ 775
...
MGLUINO = 1000
MLSP_POINTS = [1, 100, 200, 300, 400, 500, 600, 650, 700, 750, 775]
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-1000_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
