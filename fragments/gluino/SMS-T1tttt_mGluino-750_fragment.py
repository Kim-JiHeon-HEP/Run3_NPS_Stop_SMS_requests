...
# ---------------------------------------------------------------------------
# T1tttt  |  mGluino = 750 GeV  |  mLSP 6점: 300 ~ 525
...
MGLUINO = 750
MLSP_POINTS = [300, 350, 400, 450, 500, 525]
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-750_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
