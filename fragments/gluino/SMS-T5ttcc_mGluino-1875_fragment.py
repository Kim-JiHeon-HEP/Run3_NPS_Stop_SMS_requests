...
# ---------------------------------------------------------------------------
# T5ttcc  |  mGluino = 1875 GeV  |  mLSP 5점: 1675 ~ 1765
...
MGLUINO = 1875
MLSP_POINTS = [1675, 1700, 1725, 1750, 1765]
...
for mglu, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-1875_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
