...
# ---------------------------------------------------------------------------
# T2bWC  |  mStop = 1050 GeV  |  DeltaM = 10 15 20 25 30 40 50 60 70 80
...
# PDG code           mass       particle
   ...
   1000024     %MCHI%           # ~chi_1+   (mStop+mLSP)/2, AN x=0.5
...
DECAY   1000006     1.00000000E+00   # stop1 decays
    1.00000000E+00    2    1000024      5     # stop -> chargino + b
...
DECAY   1000024     1.00000000E+00   # chargino1+ decays
    1.00000000E+00    2    1000022     24     # chargino -> LSP + W(*)
...
for mstop, mlsp, nev in mpoints:
    ...
    slhatable = slhatable.replace('%MCHI%', '%e' % ((mstop + mlsp) / 2.))
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms-griddata.cern.ch/phys_generator/gridpacks_tarball/pp/13p6TeV/madgraph/SMS-StopStop/SMS-StopStop_mStop-1050_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
