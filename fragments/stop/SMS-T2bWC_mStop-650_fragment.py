...
# ---------------------------------------------------------------------------
# T2bWC  |  mStop = 650 GeV  |  DeltaM = 10 15 20 25 30 40 50 60 70 80
...
for mstop, mlsp, nev in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms-griddata.cern.ch/phys_generator/gridpacks_tarball/pp/13p6TeV/madgraph/SMS-StopStop/SMS-StopStop_mStop-650_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
