...
# ---------------------------------------------------------------------------
# T2ttC  |  mStop = 1050 GeV  |  DeltaM = 10 15 20 25 30 40 50 60 70 80 100 150
...
DECAY   1000006     1.00000000E+00   # stop1 decays
    ...
    0.00000000E+00    2    1000022      6         # on-shell top channel disabled
...
#
# Two further points, DeltaM = 100 and 150, were added on the MC&I comment of
# 2026-09-02. They lie above m_W, where the W in stop -> LSP + b + W is on shell and
# only the top is off shell. The same 3-body SLHA line covers them, so nothing else
# in this file changes; T2cc and T2bWC keep the 10-point grid because their DeltaM
# axes do not extend that way (T2cc is charm-decay only, T2bWC's axis is the
# chargino position).
MSTOP = 1050
DM_POINTS = [10, 15, 20, 25, 30, 40, 50, 60, 70, 80, 100, 150]
