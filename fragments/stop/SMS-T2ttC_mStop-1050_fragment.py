...
# ---------------------------------------------------------------------------
# T2ttC  |  mStop = 1050 GeV  |  DeltaM = 10 15 20 25 30 40 50 60 70 80
...
DECAY   1000006     1.00000000E+00   # stop1 decays
    1.00000000E+00    3    1000022      5     24  # stop -> LSP + b + W*  (top off-shell)
    0.00000000E+00    2    1000022      6         # on-shell top 경로는 끈다
